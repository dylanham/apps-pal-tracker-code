...
public class StoryFields {
    ...
    public boolean equals(Object o) {
        ...
        StoryFields storyFields = (StoryFields) o;

        if (projectId != storyFields.projectId) return false;
        return name != null ? name.equals(storyFields.name) : storyFields.name == null;
    }
