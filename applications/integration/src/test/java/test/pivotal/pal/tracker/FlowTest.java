...
public class FlowTest {
    ...
    private ApplicationServer registrationServer = new ApplicationServer(workingDir + "/../registration-server/build/libs/registration-server.jar", "8883");
    private ApplicationServer allocationsServer = new ApplicationServer(workingDir + "/../allocations-server/build/libs/allocations-server.jar", "8881");
    private ApplicationServer backlogServer = new ApplicationServer(workingDir + "/../backlog-server/build/libs/backlog-server.jar", "8882");
    private ApplicationServer timesheetsServer = new ApplicationServer(workingDir + "/../timesheets-server/build/libs/timesheets-server.jar", "8884");
