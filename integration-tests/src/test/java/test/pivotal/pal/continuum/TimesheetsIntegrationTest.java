...
public class TimesheetsIntegrationTest extends IntegrationTest {
    ...
    public void test() {
        ...
        template.execute("INSERT INTO time_entry (id, project_id, user_id, date, hours) VALUES (1, 10, 20, '2017-01-30', 8);");
        ...
        //create
        response = httpClient.post("http://localhost:8080/time-entries", MapBuilder.jsonMapBuilder()
            .put("projectId", 110)
            .put("userId", 201)
            .put("date", "2017-05-20")
            .put("hours", 6)
        ...
        //update
        response = httpClient.put("http://localhost:8080/time-entries/" + createdId, MapBuilder.jsonMapBuilder()
            .put("projectId", 111)
            .put("userId", 211)
            .put("date", "2017-05-21")
            .put("hours", 8)
